  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl pt-32 sm:pt-48 lg:pt-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Create concepts with illustrations & translations
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero ipsum iure quidem provident corporis suscipit rerum. Illo, libero alias corporis ipsa itaque.
            </p>
        ...
        <div id="concepts" className='mt-12 mx-auto max-w-7xl'>
