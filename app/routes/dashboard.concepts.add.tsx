...
import { createConcept } from '~/db/concept.server'
...
import { fetchLanguages } from '~/db/lang.server'
...
export async function action({ request }: ActionFunctionArgs) {
    ...
    try {
        ...
        const record = await createConcept(payload)
        ...
        <Form
            ...
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <h2 className="text-base font-semibold leading-7 text-gray-900">Add a concept</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Please fill the information below to add a concept
                    </p>
